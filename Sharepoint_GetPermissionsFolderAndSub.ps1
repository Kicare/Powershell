...
Function Get-PnPPermissions([Microsoft.SharePoint.Client.SecurableObject]$Object, [String] $name)
{
    Try {
...
#region ***Parameters***
$ReportFile="C:\Temp\IqoneFolderPermissionRpt$fname.csv"
$FolderRelativeURL = "Shared Documents/IHS/$fname"
#endregion
...
Get-PnPPermissions $Folder.ListItemAllFields $Folder.Name

$SubFolders = Get-PnPFolderItem -FolderSiteRelativeUrl $FolderRelativeURL -ItemType Folder | Where {$_.Name -ne "Forms" -and $_.Name -ne "Document"}
ForEach($SubFolder in $SubFolders){
    $SubFolderURL = $FolderRelativeURL+"/"+$SubFolder.Name
    $SubF = Get-PnPFolder -Url $SubFolderURL
    Get-PnPPermissions $SubF.ListItemAllFields $SubF.Name
}
